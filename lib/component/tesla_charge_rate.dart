...
@NgComponent(
    selector: 'tesla-charge-rate',
    templateUrl: 'packages/tesla_extension/component/tesla_charge_rate.html',
    cssUrl: 'packages/tesla_extension/component/tesla_charge_rate.css',
    publishAs: 'ctrl',
    map: const{
